...
export const EmptyView: FC<EmptyViewProps> = ({
  ...
  return (
    <View style={[styles.containerStyle, {backgroundColor: colors.bgColor}, containerStyle]}>
      <Image
        source={emptyIcon ? emptyIcon : images.normalEmpty}
        style={[styles.emptyIconStyle, emptyIconStyle]}
      />
      <Text style={[styles.emptyTextStyle, {color: colors.hintTextColor}, emptyTextStyle]}>
